...
const PrometheusSoftware = () => {
  const tabs = [
    ...
    },
    {
      ...
      children: (
        <div>
          <h3>Changes in Prometheus 2023.06.01</h3>
    
           <h4>Bug Fixes</h4>
          <ol>
            <li>The use of products like FireCast that leverage WISE were unable to read the FGMJ generated by the product. A bug fix was issued in 2023.06.01 to ensure WISE generated FGMJ files could be read by Prometheus.</li>
          </ol>
